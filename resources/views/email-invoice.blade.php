                                            ...
                                            <tbody>
                                                <tr
                                                    ...
                                                    <td class="content-block"
                                                        ...
                                                        valign="top">
                                                        Hai, <strong>{{ $data->user->name }}</strong>
                                                    </td>
                                                </tr>
                                                <tr
                                                    style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                                    <td class="content-block"
                                                        style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                                        valign="top">
                                                        Terima kasih sudah berbelanja di toko kami, berikut adalah
                                                        invoice order anda. <br />
                                                        Segera lakukan pembayaran jika belum melakukan pembayaran, dan
                                                        abaikan jika sudah.
                                                    </td>
                                                </tr>
                                                <tr
                                                ...
                                                <tr
                                                    ...
                                                    <td class="content-block"
                                                        style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                                        valign="top">
                                                        Berikut adalah informasi pembayaran yang harus dilakukan :
                                                        <br />
                                                        <p>- No. Invoice : {{
                                                            $data->order_code }}</p>
                                                        <p>- Bank tujuan : {{
                                                            strtoupper($data->payment_bank->order_bank) }}</p>
                                                        <p>- Nomor VA Bank : {{
                                                            $data->payment_bank->payment_va_numbers}}</p>
                                                        <p>- Jumlah yang harus di bayar : Rp. {{
                                                            number_format($data->payment_bank->payment_gross_amount)}}
                                                        </p>
                                                        <p>- Jatuh tempo pembayaran : {{
                                                            \Carbon\Carbon::parse($data->payment_bank->payment_expired)->format('d
                                                            F Y H:i')
                                                            }}</p>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr
                                                    ...
                                                    <td class="content-block"
                                                        ...
                                                        valign="top">
                                                        &copy;
                                                        @php echo date('Y'); @endphp {{ config('app.name') }}
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
